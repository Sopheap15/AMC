...
To be able to compare AMC, we follow the WHO guideline to convert antimicrobial dispensing to defined daily doses (DDDs). Sum up of all antimicrobial, we have `r round_half_up(sum(da$ddd_1000_pyear))` DDDs/1000 patient days.
