...
```
The total antimicrobial consumption in the inpatient setting is   `r round_half_up(sum(da$ddd_1000_pyear))` DDDs/1000 patient days.
...
quarter_line %>% 
	...
	labs(x = "Quarter", y = "DDDs/1000 patient days", title = "Quartely proportion of AWaRe antibiotic consumption") +
	theme_bw() +
	theme(plot.title = element_text(color = "black", face = "bold", hjust = 0.5),
				axis.text = element_text(color = "black", face = "bold"),
				legend.title = element_blank()) +
	scale_y_continuous(limits = c(min(quarter_line$n) - 50, min(quarter_line$n) + 100)) 
